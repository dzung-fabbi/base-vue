<template>
  <div>
    ...
    <div class="content">
        <div class="table-header row">
            <div class="input-group search">
                ...
                <input type="text" class="form-control" placeholder="名前・ワンコインID検索">
            </div>
    ...
    <div class="paginate d-flex justify-content-end align-items-center">
        <span class="pagination-detail">表示： 1-20 件</span>
        ...
        <span class="pagination-total ms-2">総計：12ページ</span>
    </div>
  </div>
</template>
