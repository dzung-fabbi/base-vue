    ...
    <div class="heading">
        ...
        <div class="right-heading">
            <div class="input-group date" id="datepicker" data-date-format="dd-mm-yyyy">
                ...
                <input type="text" class="form-control" placeholder="xx/yy/zzzz">
            </div>
        </div>
    </div>
    <div class="tab-slider--nav index-tab">
        <ul class="tab-slider--tabs group-info">
            <li class="tab-slider--trigger active info-item" rel="tab1">
                <div class="tab-title">
                    <div class="top-info">配信者数/月</div>
                    <div class="bottom-info">897 人</div>
                </div>
            </li>
            <li class="tab-slider--trigger info-item" rel="tab2">
                <div class="tab-title">
                    <div class="top-info">月商</div>
                    <div class="bottom-info">6897 ¥</div>
                </div>
            </li>
            <li class="tab-slider--trigger info-item" rel="tab3">
                <div class="tab-title">
